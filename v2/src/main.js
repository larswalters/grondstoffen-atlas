...
import { createGlobe, CONFIG } from "./globe.js?v=035";
import { laadVectorWereld } from "./world.js?v=035";
import { createTileLayer } from "./tiles.js?v=035";
import { laadMarnet, laadHavens, zoekRoute, zoekRouteRealistisch, bouwRouteLijn, laadBulk }
  from "./marnet.js?v=035";
