...
import { createGlobe, CONFIG } from "./globe.js?v=012";
import { laadVectorWereld } from "./world.js?v=012";
import { createTileLayer } from "./tiles.js?v=012";
import { laadMarnet, laadHavens, zoekRoute, bouwRouteLijn } from "./marnet.js?v=012";
