...
import { createGlobe, CONFIG } from "./globe.js?v=025";
import { laadVectorWereld } from "./world.js?v=025";
import { createTileLayer } from "./tiles.js?v=025";
import { laadMarnet, laadHavens, zoekRoute, bouwRouteLijn } from "./marnet.js?v=025";
