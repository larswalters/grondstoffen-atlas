...
import { createGlobe, CONFIG } from "./globe.js?v=022";
import { laadVectorWereld } from "./world.js?v=022";
import { createTileLayer } from "./tiles.js?v=022";
import { laadMarnet, laadHavens, zoekRoute, bouwRouteLijn } from "./marnet.js?v=022";
