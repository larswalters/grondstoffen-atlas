...
import { createGlobe, CONFIG } from "./globe.js?v=067";
import { laadVectorWereld } from "./world.js?v=067";
import { createTileLayer } from "./tiles.js?v=067";
import { laadMarnet, laadHavens, zoekRoute, zoekRouteRealistisch, bouwRouteLijn }
  from "./marnet.js?v=067";
import { bouwHavenLaag, zetHavenGrootte, koppelHavenLabel } from "./havens.js?v=067";
import { laadLandnet } from "./landnet.js?v=067";
import { koppelNetten, zoekKeten, havenZaden, puntZaden, GROEP_NAAM } from "./keten.js?v=067";
import { laadStromen, routeerStroom } from "./stromen.js?v=067";
import { bouwStroomLaag, zetMerkGrootte } from "./stroomlaag.js?v=067";
...
// losgekoppeld: marnet/landnet/ports/knooppunten zijn sinds ?v=067 niet
...
let K = null;
let REGISTER = null;
fetch("data/knooppunten.json?v=067")
