...
import { createGlobe, CONFIG } from "./globe.js?v=023";
import { laadVectorWereld } from "./world.js?v=023";
import { createTileLayer } from "./tiles.js?v=023";
import { laadMarnet, laadHavens, zoekRoute, bouwRouteLijn } from "./marnet.js?v=023";
