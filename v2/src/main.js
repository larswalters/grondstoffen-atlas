...
import { createGlobe, CONFIG } from "./globe.js?v=068";
import { laadVectorWereld } from "./world.js?v=068";
import { createTileLayer } from "./tiles.js?v=068";
import { laadMarnet, laadHavens, zoekRoute, zoekRouteRealistisch, bouwRouteLijn }
  from "./marnet.js?v=068";
import { bouwHavenLaag, zetHavenGrootte, koppelHavenLabel } from "./havens.js?v=068";
import { laadLandnet } from "./landnet.js?v=068";
import { koppelNetten, zoekKeten, havenZaden, puntZaden, GROEP_NAAM } from "./keten.js?v=068";
import { laadStromen, routeerStroom } from "./stromen.js?v=068";
import { bouwStroomLaag, zetMerkGrootte } from "./stroomlaag.js?v=068";
...
// losgekoppeld: marnet/landnet/ports/knooppunten zijn sinds ?v=068 niet
...
let K = null;
let REGISTER = null;
fetch("data/knooppunten.json?v=068")
