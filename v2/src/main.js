...
import { createGlobe, CONFIG } from "./globe.js?v=011";
import { laadVectorWereld } from "./world.js?v=011";
import { createTileLayer } from "./tiles.js?v=011";
import { laadMarnet, laadHavens, zoekRoute, bouwRouteLijn } from "./marnet.js?v=011";
