...
REGISTER({
  ...
  nodes: [
    ...
    { id: "gr-mozambique", type: "mine", name: "Balama (Twigg)", country: "Mozambique",
      lat: -13.310, lon: 38.660, share: 13, tier: 1, operator: "Syrah Resources",
      status: "actief", capacity: "≈ 350 kt/j (nameplate)",
      note: "Grootste vlokmijn buiten China. Het vlok gaat twee kanten op: het leeuwendeel naar de Chinese verwerking, én een deel naar Syrah's eigen anodefabriek in Vidalia (Louisiana) — het niet-Chinese draadje. Coördinaat = de plant zelf (bagging on-site; routebrief grafiet-balama-vidalia)." },
    ...
    { id: "gr-port-neworleans", type: "port", name: "New Orleans", country: "VS",
      lat: 29.9123, lon: -90.112, tier: 2,
      note: "Golf-gateway voor Syrah Vidalia: de zeecontainers met Balama-vlok landen op het Napoleon Avenue Container Terminal (coördinaat = die kade). De rivierbarge wordt in Port Allen (Baton Rouge) beladen — DOE/EA-2181; praktijk t/m 2024 was truck (routebrief grafiet-balama-vidalia). ⚠️ 489 m VERPLAATST bij de anker-check van 2026-07-28 (satelliet-gelegd op Esri z16, goedkeuring Lars): het punt stond aan de LANDZIJDE vóór het rangeerterrein, tegen de woonwijk aan. De containerkade met de blauwe portaalkranen en het afgemeerde schip ligt ~490 m zuidelijker aan de rivier — en dát is het punt waar het zeeschip op de barge overgaat, dus de overslag verschoof mee (stroomroute-pilot.json herbakken)." },
  ...
  flows: [
    ...
    { from: "gr-mozambique", to: "gr-ref-vidalia", value: 20, mode: "ship", stage: "erts",
      via: ["gr-port-nacala", "wp-kaap", "wp-atl-west", "wp-florida", "gr-port-neworleans"],
      note: "Het niet-Chinese draadje: Balama-vlok in containers rond de Kaap naar New Orleans (Napoleon Ave); de rivierbarge wordt in Port Allen beladen, lost bij de Port of Vidalia (mijl 359) — DOE/EA-2181; praktijk t/m 2024 was truck. Waarde = EA-regime fase 1 (~20,5 kt/j); de Golf-toegang (wp-florida vs Yucatán) is onzeker. Zie routebrief grafiet-balama-vidalia." },
